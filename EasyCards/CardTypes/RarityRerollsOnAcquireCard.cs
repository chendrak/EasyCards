...
public abstract class RarityRerollsOnAcquireCard : SingleEffectCard
{
    ...
    {
        ["en"] = $"Grants you {this.CardValue} rarity rerolls",
    };

    protected override void OnAcquire(PlayerData playerData) => playerData.RarityRerollLeft += this.CardValue;

    protected RarityRerollsOnAcquireCard(IntPtr ptr) : base(ptr) {}
}
